/*
 * ================================================================
 * DEBUG VARIANTE C: OHNE QMC5883P (kein Magnetometer!)
 * Test: Läuft der Sensor-Stack ohne QMC5883P stabil?
 * Falls JA → QMC5883P (0x2C) ist das Problem!
 * ================================================================
 */
...
// #include <qmc5883p.h>          // <-- DEAKTIVIERT: Magnetometer QMC5883P
...
void setup() {
    Serial.begin(115200);
    Serial.println("[DEBUG C] Start OHNE QMC5883P Magnetometer");
...
void loop() {
    if (dataReady) {
        ...
        // MAG deaktiviert → Werte bleiben 0, nur Gyro+Acc für Madgwick
        float m[3] = {0, 0, 0};
        ...
        // Madgwick ohne Mag (nur 6DOF Modus)
